...
/* Date de création :  23/02/2018 14:25:58                      */
/*==============================================================*/
...
alter table realise add constraint FK_realise foreign key (id_groupe)
      references groupe (id_groupe) on delete restrict on update cascade;
...
alter table traverse add constraint FK_traverse2 foreign key (identifiant_op)
      references ville (identifiant_op) on delete cascade on update cascade;
